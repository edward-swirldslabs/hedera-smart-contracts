...
Environment overrides:
  ...
  SOLO_CLUSTER_REF             (default: solo-clpr-msg)
  SOLO_SRC_DEPLOYMENT          (default: solo-clpr-msg-src)
  SOLO_DST_DEPLOYMENT          (default: solo-clpr-msg-dst)
  SOLO_SRC_NAMESPACE           (default: solo-clpr-msg-src)
  SOLO_DST_NAMESPACE           (default: solo-clpr-msg-dst)
