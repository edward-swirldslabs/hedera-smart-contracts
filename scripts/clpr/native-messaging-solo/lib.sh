...
SOLO_CLUSTER_REF="${SOLO_CLUSTER_REF:-solo-clpr-msg}"
SOLO_CLUSTER_SETUP_NAMESPACE="${SOLO_CLUSTER_SETUP_NAMESPACE:-solo-setup}"

SOLO_SRC_DEPLOYMENT="${SOLO_SRC_DEPLOYMENT:-solo-clpr-msg-src}"
SOLO_DST_DEPLOYMENT="${SOLO_DST_DEPLOYMENT:-solo-clpr-msg-dst}"
SOLO_SRC_NAMESPACE="${SOLO_SRC_NAMESPACE:-solo-clpr-msg-src}"
SOLO_DST_NAMESPACE="${SOLO_DST_NAMESPACE:-solo-clpr-msg-dst}"
