...
public class ClprQueueEnqueueMessageResponseTranslator extends AbstractCallTranslator<ClprQueueCallAttempt> {
    ...
    public static final SystemContractMethod ENQUEUE_MESSAGE_RESPONSE = SystemContractMethod.declare(
            ENQUEUE_MESSAGE_RESPONSE_SIGNATURE, "(uint64)");
    ...
    public Call callFrom(@NonNull final ClprQueueCallAttempt attempt) {
        ...
        try {
            ...
            return new ClprQueueEnqueueMessageResponseCall(
                    attempt.systemContractGasCalculator(), attempt.enhancement(), attempt.inputBytes(), response);
