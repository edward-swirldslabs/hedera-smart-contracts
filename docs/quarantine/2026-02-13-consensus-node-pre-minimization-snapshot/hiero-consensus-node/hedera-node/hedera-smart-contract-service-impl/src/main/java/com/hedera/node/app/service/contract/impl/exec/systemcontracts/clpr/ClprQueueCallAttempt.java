...
public class ClprQueueCallAttempt extends AbstractCallAttempt<ClprQueueCallAttempt> {
    ...
    public static final SystemContractMethod UNSUPPORTED_SELECTOR_METHOD =
            SystemContractMethod.declare("unsupportedSelector(bytes4)", ReturnTypes.INT_64)
                    .withContract(SystemContractMethod.SystemContract.CLPR);

    public ClprQueueCallAttempt(@NonNull final Bytes input, @NonNull final CallAttemptOptions<ClprQueueCallAttempt> options) {
