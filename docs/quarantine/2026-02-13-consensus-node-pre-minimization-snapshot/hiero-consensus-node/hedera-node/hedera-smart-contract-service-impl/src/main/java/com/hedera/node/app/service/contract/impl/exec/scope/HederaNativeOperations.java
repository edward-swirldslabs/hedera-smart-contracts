...
public interface HederaNativeOperations {
    ...
    /**
     * Returns the {@link WritableClprMessageQueueMetadataStore} for this {@link HederaNativeOperations}.
     *
     * @return the writable CLPR message queue metadata store
     */
    default @NonNull WritableClprMessageQueueMetadataStore writableClprMessageQueueMetadataStore() {
        throw new UnsupportedOperationException("CLPR queue metadata store is unavailable in this context");
    }

    /**
     * Returns the {@link WritableClprMessageStore} for this {@link HederaNativeOperations}.
     *
     * @return the writable CLPR message store
     */
    default @NonNull WritableClprMessageStore writableClprMessageStore() {
        throw new UnsupportedOperationException("CLPR message store is unavailable in this context");
    }
