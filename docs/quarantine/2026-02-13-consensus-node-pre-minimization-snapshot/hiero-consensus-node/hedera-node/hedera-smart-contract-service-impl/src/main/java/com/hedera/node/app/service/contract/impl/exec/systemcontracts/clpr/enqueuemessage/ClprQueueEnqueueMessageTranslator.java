...
public class ClprQueueEnqueueMessageTranslator extends AbstractCallTranslator<ClprQueueCallAttempt> {
    ...
    public static final SystemContractMethod ENQUEUE_MESSAGE = SystemContractMethod.declare(
            ENQUEUE_MESSAGE_SIGNATURE, "(uint64)");
    ...
    public Call callFrom(@NonNull final ClprQueueCallAttempt attempt) {
        ...
        try {
            ...
            return new ClprQueueEnqueueMessageCall(
                    attempt.systemContractGasCalculator(), attempt.enhancement(), attempt.inputBytes(), message);
