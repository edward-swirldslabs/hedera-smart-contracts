...
public class HandleHederaNativeOperations implements HederaNativeOperations {
     ...
     */
    @Override
    public @NonNull WritableClprMessageQueueMetadataStore writableClprMessageQueueMetadataStore() {
        return context.storeFactory().writableStore(WritableClprMessageQueueMetadataStore.class);
    }
     ...
     */
    @Override
    public @NonNull WritableClprMessageStore writableClprMessageStore() {
        return context.storeFactory().writableStore(WritableClprMessageStore.class);
    }
